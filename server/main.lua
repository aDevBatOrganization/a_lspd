...
TriggerEvent('esx_society:registerSociety', 'police', 'Police', 'society_police', 'society_police', 'society_police',
	'society_police_saisie', { type = 'public' })
...
RegisterServerEvent('esx_policejob:getSaisieItem')
AddEventHandler('esx_policejob:getSaisieItem', function(itemName, count)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
	local sourceItem = xPlayer.getInventoryItem(itemName)

	TriggerEvent('esx_addoninventory:getSharedInventory', 'society_police_saisie', function(inventory)
		local inventoryItem = inventory.getItem(itemName)
...
RegisterServerEvent('esx_policejob:putSaisieItems')
AddEventHandler('esx_policejob:putSaisieItems', function(itemName, count)
	local xPlayer = ESX.GetPlayerFromId(source)
	local sourceItem = xPlayer.getInventoryItem(itemName)
...
ESX.RegisterServerCallback('esx_policejob:getSaisieItems', function(source, cb)
	TriggerEvent('esx_addoninventory:getSharedInventory', 'society_police_saisie', function(inventory)
		cb(inventory.items)
	end)
end)
